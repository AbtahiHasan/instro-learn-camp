...
const WhyChoose = () => {
    return (
        <div className="container mt-[140px]">
            ...
            <div className="md:w-[60%] mx-auto grid md:grid-cols-3 mt-10 gap-10">
                <div className="md:border-r-2 p-3 text-center flex justify-center items-center flex-col">
                    <h3 className="text-xl">6+ YEARS</h3>
                    <p>Online Lessons</p>
                </div>
                <div className="border-t-2 pt-5 md:pt-3 md:border-t-0 md:border-r-2 p-3 text-center flex justify-center items-center flex-col">
                    <h3 className="text-xl">2,000+</h3>
                    <p>Performances</p>
                </div>
                <div className="border-t-2 pt-5 md:pt-3 md:border-none text-center flex justify-center items-center flex-col">
