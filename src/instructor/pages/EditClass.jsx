            ...
            <div className="text-center my-3">
                ...
                <section className="md:grid md:grid-cols-2 gap-3 w-full">
                    <div className="w-full my-2">
                        ...
                        <input {...register("class_name")} defaultValue={class_name} type="text" className="w-full px-4 py-3 outline-0 mt-3 rounded border" autoComplete="off" placeholder="class Name"/>
                    </div>
                    <div className="w-full my-2">
                    ...
                    <div className="w-full my-2">
                        ...
                        <input {...register("avilable_seats")} type="number" defaultValue={avilable_seats}  className="w-full px-4 py-3 outline-0 mt-3 rounded border" autoComplete="off"  />
                    </div>
                    <div className="w-full my-2">
                        <span className="block font-bold">Price</span>
                        <input {...register("price")} type="number" defaultValue={price} className="w-full px-4 py-3 outline-0 mt-3 rounded border" autoComplete="off"  />
                    </div>
                </section>
